...
<html lang="en">
	<head>
		...
		<script src="js/script-tagihan.js"></script>
	...
	<body style="background-color: #e9ecef;">
						...
						<div class="container rounded mt-4 pt-2 mr-2 pb-2" style="display: none;" id="container-tambah">
							<form  id="form-tagihan" method="post" enctype="multipart/form-data">
								...
								<div class="row bg-white mt-2 pt-4 pb-2">
									<div class="col">
										<input type="hidden" name="no_tagihan" id="no_tagihan">
										...
										<button type="button" class="btn btn-primary mb-2 tambah-tagihan" data-toggle="modal" data-target="#modal-tambah-tagihan">Tambah Tagihan</button>
									</div>
								</div>
								<div class="row bg-white mt-2 pt-4">
									<div class="col">
										<table class="table table-striped table-bordered table-number" id="table-jenis-tagihan" style="width:100%;">
											<thead>
												<tr>
													<th>No</th>
		...
		<!-- Modal -->
		<div class="modal fade" id="modal-tambah-tagihan" tabindex="-1" role="dialog" aria-labelledby="formModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="" id="form-modal-kode-tagihan" enctype="multipart/form-data">
							<div class="form-group text-center">
								<input type="hidden" name="id" class="form-control" id="id" >
							</div>
							<div class="form-group">
								<label for="modal-kode">Kode Jenis Tagihan</label>
								<select name="modal-kode" id="modal-kode" class="form-control">
							...
							<div class="form-group">
								...
								<input type="number" class="form-control" name="modal-nilai" id="modal-nilai">
							</div>
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-danger close-modal" data-dismiss="modal">Close</button>
							<button type="submit" class="btn btn-primary submit" id="submit_tagihan">Tambah Data</button>
						</div>
					</form>
				</div>
			</div>
